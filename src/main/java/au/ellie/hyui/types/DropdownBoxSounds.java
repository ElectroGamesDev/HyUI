...
/**
 * DropdownBoxSounds type definition.
 */
public class DropdownBoxSounds implements HyUIBsonSerializable {
    private SoundStyle activate;
    private SoundStyle mouseHover;
    private SoundStyle close;

    public DropdownBoxSounds withActivate(SoundStyle activate) {
        this.activate = activate;
        return this;
    }

    public DropdownBoxSounds withMouseHover(SoundStyle mouseHover) {
        this.mouseHover = mouseHover;
        return this;
    }

    public DropdownBoxSounds withClose(SoundStyle close) {
        this.close = close;
        return this;
    }
